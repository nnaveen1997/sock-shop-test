#user and password should be moved to .env for privacy of data

import requests

#Testing login and GET /orders
def test_get_orders_customer(base_url, user, password):
    s = requests.Session()
    s.auth = (user, password)
    # s.headers.update({'x-test': 'true'})
    s.get('http://localhost/login')#, headers={'x-test': 'true'})

    api = base_url + '/orders'
    expected_result = [{"customerId":"57a98d98e4b00679b4a830b2","customer":{"firstName":"User","lastName":"Name","username":"user","addresses":[],"cards":[]},"address":{"number":"246","street":"Whitelees Road","city":"Glasgow","postcode":"G67 3DL","country":"United Kingdom"},"card":{"longNum":"5544154011345918","expires":"08/19","ccv":"958"},"items":[{"itemId":"3395a43e-2d88-40de-b95f-e00e1502085b","quantity":1,"unitPrice":18}],"shipment":{"name":"57a98d98e4b00679b4a830b2"},"date":"2022-05-30T11:54:30.684+0000","total":22.99,"_links":{"self":{"href":"http://orders/orders/6294b07697a1c00007ffa85b"},"order":{"href":"http://orders/orders/6294b07697a1c00007ffa85b"}}}]
